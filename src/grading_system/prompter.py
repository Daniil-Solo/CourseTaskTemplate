...
class MockPrompter(BasePrompter):
    def prepare_system_prompt(self, gh_repo_url: str) -> str:
        return (
            ...
            "## Формат ответа: \n"
            "Напиши для каждого критерия: соблюден ли он и какая возможно есть проблема \n"
            "Сделай глубокий вдох. \n"
            "Далее напиши снова для каждого несоблюденного критерия напиши совет по улучшению кода. \n"
            "Избегай написания кода решения задания \n"
        )
